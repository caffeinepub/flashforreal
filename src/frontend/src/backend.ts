...
export class Backend implements backendInterface {
    ...
    async createPackage(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllOrders(): Promise<Array<UsdtOrderView>> {
        if (this.processError) {
            try {
    ...
    async getAllPackages(): Promise<Array<UsdtPackage>> {
        if (this.processError) {
            try {
    ...
    async getOrder(arg0: bigint): Promise<UsdtOrderView> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
